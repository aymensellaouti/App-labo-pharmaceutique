...
class MedecinController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MedecinBundle:Medecin')->findAll();

      //  var_dump($em->getRepository('MedecinBundle:Secteur')->findBy(a));
        return $this->render('MedecinBundle:Medecin:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        /*
            var_dump($request->get('specialite'));
            die;
        */
        if ($form->isValid()) {
            $em = $this->getDoctrine()->getManager();
        ...
        return $this->render('MedecinBundle:Medecin:new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm(new MedecinType($this->get('security.context')), $entity, array(
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MedecinBundle:Medecin')->find($id);
        ...
        return $this->render('MedecinBundle:Medecin:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MedecinBundle:Medecin:edit.html.twig', array(
            'entity'      => $entity,
